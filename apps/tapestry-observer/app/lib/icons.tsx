/**
 * Shared icon components for Tapestry Observer
 *
 * Extracted from route files so they can be reused across
 * messages, threads, agent details, and channel details.
 */
...
/** Agent/server icon (used in chat bubbles and cards) */
...
/** User/person icon (generic sender) */
