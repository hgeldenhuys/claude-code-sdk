...
const DEFAULT_ADJECTIVES = [
  'brave', 'swift', 'happy', 'calm', 'bright', 'clever', 'eager', 'gentle',
  'jolly', 'kind', 'lively', 'merry', 'noble', 'proud', 'quick', 'quiet',
  'sharp', 'smart', 'steady', 'strong', 'sunny', 'tender', 'warm', 'wise',
  'agile', 'bold', 'cosmic', 'daring', 'earnest', 'fair', 'golden', 'honest',
  'keen', 'lucky', 'mighty', 'neat', 'peaceful', 'radiant', 'serene', 'trusty',
  'valiant', 'witty', 'zealous', 'amber', 'azure', 'coral', 'crimson', 'emerald',
  'ivory', 'jade', 'ruby', 'silver', 'violet', 'crystal', 'misty', 'stellar'
];

const DEFAULT_NOUNS = [
  'elephant', 'falcon', 'tiger', 'dolphin', 'phoenix', 'dragon', 'panther',
  'eagle', 'wolf', 'bear', 'lion', 'hawk', 'owl', 'raven', 'fox', 'deer',
  'horse', 'whale', 'shark', 'otter', 'badger', 'heron', 'crane', 'swan',
  'lynx', 'puma', 'cobra', 'viper', 'python', 'condor', 'osprey', 'jaguar',
  'cheetah', 'gazelle', 'antelope', 'buffalo', 'bison', 'moose', 'elk',
  'squid', 'octopus', 'mantis', 'beetle', 'hornet', 'wasp', 'spider',
  'scorpion', 'coyote', 'jackal', 'hyena', 'leopard', 'ocelot', 'mongoose'
];
